	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().ignoringAntMatchers("/**");
		  ...
		  http.antMatcher("/**").httpBasic().authenticationEntryPoint(restServicesEntryPoint()).and()
		    ...
		    .antMatchers(HttpMethod.POST, "/admin/config_schedule").access("hasRole('ROLE_ADMIN')")
		    .antMatchers(HttpMethod.POST, "/admin/check_schedule").permitAll()
		    .antMatchers(HttpMethod.POST, "/admin/update_appointment").access("hasRole('ROLE_ADMIN')")
